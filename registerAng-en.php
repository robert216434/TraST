...
<head>
    ...
    <link rel = "stylesheet" type = "text/css" href = "butoane.css">
...
<?php
    ...
    if($eroare!=1){
        ...
        $statement2->fetch();
        $statement2->close();
        header("location: loginAng-en.php");
    }
    }
    }
    ?>
    <div class="card">
            ...
            <form class="form" method="post">
                ...
                <h2 id="localitate-title">Phone number: </h2>
