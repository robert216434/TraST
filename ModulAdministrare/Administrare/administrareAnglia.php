...
<body class="leg" onload="ceas(); setInterval('ceas()', 1000 )">
    ...
    <script>
        ...
        function logoutUser() {
            ...
            phtp.open("GET", "../../ConectareaUseruluiLaWebsite/Logout/logoutAnglia.php", true);
            phtp.send();
        }
        ...
        function deleteUser() {
            ...
            if (userDeleteQuery == "") {
                alert("you didn't write nothing");
        ...
        function createUser() {
            ...
            if (usr == "" || par == "" || ema == "" || num == "" || lcl == "" || dtn == "" || tel == "") {
                alert("you forgot to fill a inputbox");
        ...
        function modifyUser() {
            if (document.getElementById("usernama").value == "") {
                alert('you didn t write the username');
                return;
    ...
    <div class="backgroundImage" style="background-image: url('../../MediaContent/imagini/audi.jpg');">
        ...
        <div class="operatiiAdministrare">
            ...
            <form class="formularAdministrare" action="javascript:createUser()">
                ...
                <input class="inputFormularAdministrare" type="password" id="parol" size="50" placeholder="Password">
                <input class="inputFormularAdministrare" type="text" id="numpr" size="50" placeholder="Name">
                <input class="inputFormularAdministrare" type="text" id="loclt" size="50" placeholder="City">
                <input class="inputFormularAdministrare" type="text" id="email" size="50" placeholder="Email">
                <input class="inputFormularAdministrare" type="text" id="dtnas" size="50" placeholder="Date of birth">
                <input class="inputFormularAdministrare" type="text" id="telef" size="50" placeholder="Phone number">
            ...
            <form class="formularAdministrare" action="javascript:modifyUser()">
                ...
                <input class="inputFormularAdministrare" type="password" id="parolee" size="50" placeholder="Password">
                <input class="inputFormularAdministrare" type="text" id="punctaje" size="50" placeholder="Points">
                <input class="inputFormularAdministrare" type="text" id="numeprena" size="50" placeholder="Name">
                <input class="inputFormularAdministrare" type="text" id="localita" size="50" placeholder="City">
                <input class="inputFormularAdministrare" type="text" id="emailado" size="50" placeholder="Email">
                <input class="inputFormularAdministrare" type="text" id="datanas" size="50" placeholder="Date of birth">
                <input class="inputFormularAdministrare" type="text" id="telefono" size="50" placeholder="Phone number">
                <input class="submitFormularAdministrare" type="submit" value="Submit">
            </form>
        ...
        <footer class="homeF-en">La revedere!.<br><span id="ceas"></span></footer>
