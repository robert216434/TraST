...
if($images[0]!=null)
{
  ...
  $this->currentSignTable[]="<img src='imagini/NotUsedSmall.png' alt='img' style='width:100px;height:50px;'/>";
...
if($images1[0]!=null)
{
  ...
  $this->currentSignTable1[]="<img src='imagini/NotUsedSmall.png' alt='img' style='width:100px;height:50px;' />";
