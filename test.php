...
<body id="testContent" class="backgroundImage" style="background-image: url('imagini/audi.jpg');">


<div class="timerCorectGresit"><pre>Timp ramas: <span id="time">30:00</span>   Raspunsuri corecte: <span id="raspunsuriCorecte"></span>   Raspunsuri gresite: <span id="raspunsuriGresite"></span>
</pre>
</div>
