...
;changeButtonColor('12');setInterval(function() { changeButtonColor('12'); },5100)" class="backgroundImage" style="background-image: url('imagini/audi.jpg');">
...
<button id="12" class="CompareButtons" onclick="document.location='semne_de_circulatie.php'">Inapoi</button>
