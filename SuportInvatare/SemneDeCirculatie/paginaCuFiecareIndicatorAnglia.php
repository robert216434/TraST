...
<head>
  ...
  <link rel="stylesheet" href="paginaCuFiecareIndicatorStyleSheet.css">
...
;changeButtonColor('BackBA');setInterval(function() { changeButtonColor('BackBA'); },5100)">
  ...
  <div class="backgroundImage" style="background-image: url('../../MediaContent/imagini/audi.jpg');">
    ...
    ?>
    <div class="NBQA">
      <form action="paginaCuFiecareIndicatorAnglia.php" method="POST">
        <button id="BackA" name="Back1">Back</button>
        <button id="NextA" name="Next1">Next</button>
      </form>

      <button id="BackBA" onclick="document.location='paginaCuToateSemneleAnglia.php'">Back to the road sign page</button>
