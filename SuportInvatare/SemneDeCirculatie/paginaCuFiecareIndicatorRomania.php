...
;changeButtonColor('BackB');setInterval(function() { changeButtonColor('BackB'); },5100)">
  ...
  <div class="backgroundImage" style="background-image: url('../../MediaContent/imagini/audi.jpg');">
    ...
    <div class="NBQ">
      <form action="paginaCuFiecareIndicatorRomania.php" method="POST">
        <button id="Back" name="Back">Inapoi</button>
        <button id="Next" name="Next">Urmatorul</button>
      </form>

      <button id="BackB" onclick="document.location='paginaCuToateSemneleRomania.php'">Inapoi la pagina cu semne</button>
