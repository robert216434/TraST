...
;changeButtonColor('17');setInterval(function() { changeButtonColor('17'); },5100)" class="backgroundImage" style="background-image: url('imagini/audi.jpg');">
...
<button id="17" class="CompareButtonsAng" onclick="document.location='semne_de_circulatieAng-en.php'">Back</button>
<script>
   function sleep(ms) {
